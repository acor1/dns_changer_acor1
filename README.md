...
- 🔒 DNS-over-TLS (DoT) — Cloudflare, Google, Quad9, AdGuard
- ⚡ بنچمارک هوشمند با resolve واقعی (۵ دامنه)
- 🎯 Split DNS دائمی
- 🔍 تست نشت DNS
- 📊 آمار Cache
- 🕒 تاریخچه تغییرات
- ♻️ بکاپ و ری‌استور خودکار
- 🇮🇷 پشتیبانی از Shecan و 403 DNS
- 🖥 دستورات `--help`, `--version`, `--restore`, `--no-deps`

**تغییرات:**

- تشخیص دقیق systemd-resolved از ۴ روش
- بهبود UI و منو
- سازگاری با تمام Ubuntu 18.04+
...
Pull Request و Issue خوش‌آمدن! اگه قابلیت جدیدی پیشنهاد داری:
...
- از `shellcheck` استفاده کن
- کد رو با ۲ فاصله indent کن
- کامنت فقط جایی که لازمه
